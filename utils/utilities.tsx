...
export const filteredTasksByMonth = (tasks: Task[], month: string) => {
  ...
  return tasks.filter((task) => {
    return moment(task.dueDate).format("MMMM").toLowerCase() === month;
  });
};

export const filteredTasksByYear = (tasks: Task[], year: string) => {

  return tasks.filter((task) => {
    return moment(task.dueDate).format("YYYY").toLowerCase() === String(year);
  });
}
